...
The following questions were adapted from this textbook. Questions 1-4 are optional if you would like a short review of 511.
...
Below are the mathematical steps for solving OLS for SLR. For each blank explanation, please describe in words why we made the mathematical step.
