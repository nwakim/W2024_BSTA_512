...
-   Look at all other relationships between IAT score and each covariate.
    ...
    -   For categorical variables, is there an inherent order? Does the ordered values follow a linear relationship? Are the categories evenly spaced? Think education - is there a natural place to divide the categories up??
