...
|-------------|-------------|:-------------------:|:------------:|:-----------:|
|         | Intro                              |          [[{{< iconify ri slideshow-fill size=30px >}}](../slides/0_Intro.qmd)]{style="color:#49A3D1;"}          |                                                                                    | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 1       | Outcomes, Events, and Sample Space | [[{{< iconify ri slideshow-fill size=30px >}}](../slides/1_Outcomes_Events_Sample.qmd)]{style="color:#49A3D1;"}  | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 2       | Probability                        |       [[{{< iconify ri slideshow-fill size=30px >}}](../slides/2_Probability.qmd)]{style="color:#f8f5f0;"}       | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 22      | Counting                           | [[{{< iconify ri slideshow-fill size=30px >}}](/slides/22_Counting_Intro-solutions.qmd)]{style="color:#f8f5f0;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
...
|                  |                                                                                                                                                                                                                                     |
|-------------|-----------------------------------------------------------|
| Monday (9/25)    | [[{{< iconify healthicons health-worker-form-negative size=30px >}}](https://forms.office.com/Pages/ResponsePage.aspx?id=V3lz4rj6fk2U9pvWr59xWFMopmPUjRtDiHLswhgacNhUMkNKRDJMUk5DVVNZOEZXNVNXMzZHVjZSOC4u)]{style="color:#f8f5f0;"} |
| Wednesday (9/27) | [{{< iconify healthicons health-worker-form-negative size=30px >}}]{style="color:#f8f5f0;"}                                                                                                                                         |
...
-   Combinatorics practice problems
    -   [handout](/schedule/week_01/Ch22-combinatorics-practice-B550.pdf) (& [answers](/schedule/week_01/Ch22-combinatorics-practice-B550-ANSWERS.pdf))
