...
Below is a table with links to resources. Icons in [blue]{style="color:#49A3D1;"} mean there is an available file link.
...
| 2       | Probability                        |                              [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"}                              | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 22      | Counting                           |                              [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"}                              | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
...
[Homework 1 due 10/1](../homework/HW1.qmd)
