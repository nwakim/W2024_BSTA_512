...
| 2       | Probability                        |         [[{{< iconify ri slideshow-fill size=30px >}}](../slides/2_Probability-solutions.qmd)]{style="color:#f8f5f0;"}          | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
