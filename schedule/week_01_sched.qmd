...
| 1       | Outcomes, Events, and Sample Space | [[{{< iconify ri slideshow-fill size=30px >}}](../slides/1_Outcomes_Events_Sample.qmd)]{style="color:#49A3D1;"}  | [[{{< iconify pepicons-pop pen-circle-filled size=29px >}}](../slides_annotated/01_Outcomes_Events_Sample.pdf)]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
...
### Why is the number of possible events $2^{|S|}$?
...
#### Outcomes with no probability

The same can be said for outcomes without probability.

Both or nrither ehads nor tails
