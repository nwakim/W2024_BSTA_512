...
|---------------|---------------|:-------------:|:-------------:|:-------------:|
| 28      | Expected value of continuous RVs | [[{{< iconify ri slideshow-fill size=30px >}}](../slides/28_Expected_Values.qmd)]{style="color:#49A3D1;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
