...
## Slide with my regression analysis process!!!
...
::: hl
Our goal in regression is to estimate $\beta_0$, $\beta_1$, and
$\sigma^2$

-   The point estimates based on a sample are denoted by
    $\hat{\beta}_0$, $\hat{\beta}_1$, and $\widehat{\sigma^2}$
:::
...
## Make it clear on same slide that 

![](images/Screenshot 2024-01-13 at 11.41.10 AM.png)
...
![](images/Screenshot 2024-01-13 at 11.41.54 AM.png)
