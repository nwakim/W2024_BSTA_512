...
-   We ran the `augment()` function to get some diagnostic values,
...
-   Try a transformation if there is an issue with linearity
...
-   We can transform the dependent ( $Y$ ) variable of the independnet (
    $X$) variable
...
About the
homework??![](images/Screenshot%202024-01-30%20at%202.39.18%20PM.png)
