...
iat_new = iat_old %>% # iat_old should not have any NA's in genderIdentity
  mutate(genderID = case_match(genderIdentity,
                               ...
                               genderqueer/non-conforming, or other"))
```
...
-   Example : if someone identifies as a man and a trans man, their data are like:
    ...
    -   $I(Gender = \text{Trans male/man, trans female/woman, genderqueer/non-conforming, or other}) = 1$
...
-   Education: I saw many of us speculate that higher education may be associated with lower IAT (as a potential confounder)
    ...
    -   We can think about people's perception of controllability of weight, maybe it's link to perceived laziness

        -   Which contradicts a lot of people's perceptions on the dedication and hard work needed higher education
