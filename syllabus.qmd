...
+---------------------+------------------------+----------------+-------------------------------+
| Homework            | Formative              | Approx. weekly | 55%                           |
+---------------------+------------------------+----------------+-------------------------------+
| Post-class survey   | N/A                    | Twice Weekly   | 5%                            |
+---------------------+------------------------+----------------+-------------------------------+
| Midterm Exam        | Summative              |                | 20%                           |
+---------------------+------------------------+----------------+-------------------------------+
...
-   **Do not stop once ChatGPT answered a question.** If it gives an explanation, interact with it! Make sure you understand the thought process of ChatGPT. Check the answer with what we learn in class.
...
At the end of the day, ChatGPT is a resource that will be available to you in a job and outside of school. Thus, we should use it as a tool in school as well!
