...
| 1      | Review | [[{{< iconify ri slideshow-fill size=30px >}}](/slides/01_Review.qmd)]{style="color:#f8f5f0;"}  | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
