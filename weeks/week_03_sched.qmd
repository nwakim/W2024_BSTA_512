...
"Why isn't the random input considered to be the random variable, while the function is"a function with a random input"? The output of the function is deterministic, not random, after all."
...
-   Still random bc each value that the random variable takes is with a specific probability (not a certainty)
