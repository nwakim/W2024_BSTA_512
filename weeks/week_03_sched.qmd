...
|-----------|-----------|:---------:|:---------:|:--------------------------:|
| 4      |       | [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#f8f5f0;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} | [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"} |
| 5      |       | [{{< iconify ri slideshow-fill size=30px >}}]{style="color:#49A3D1;"} | [{{< iconify pepicons-pop pen-circle-filled size=29px >}}]{style="color:#f8f5f0;"} |                                [{{< iconify mdi video size=34px >}}]{style="color:#f8f5f0;"}                                |
